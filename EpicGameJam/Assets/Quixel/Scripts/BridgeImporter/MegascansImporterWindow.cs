...
namespace Quixel {
    public class MegascansImporterWindow : EditorWindow {
        ...
        public static void Init () {
            ...
            header.text = " Bridge LiveLink v" + version;
        ...
        void OnEnable () {
            ...
            size = SuperHD ? new Vector2 (567, 1080) : new Vector2 (308, 550);
            mainSize = SuperHD ? new Rect (0, 0, 567, 2100) : new Rect (0, 0, 308, 1080);
            ...
            collisionLoc = SuperHD ? new Rect (25, 652, 32, 32) : new Rect (13, 350, 17, 17);
            terrainNormalLoc = SuperHD ? new Rect (25, 732, 32, 32) : new Rect (13, 393, 17, 17);
            applyToSelectionLoc = SuperHD ? new Rect(25, 814, 32, 32) : new Rect(13, 436, 17, 17);
            addAssetToSceneLoc = SuperHD ? new Rect(25, 895, 32, 32) : new Rect(13, 479, 17, 17);
            connectionLoc = SuperHD ? new Rect (25, 975, 32, 32) : new Rect (13, 522, 17, 17);
